...
export function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  return (
    <div className={cn(
      "fixed left-0 top-0 h-full bg-white shadow-2xl z-40 transition-all duration-300 border-r border-gray-200 flex flex-col",
      isOpen ? "w-64" : "w-16"
    )}>
      {/* Logo */}
      <div className="h-16 flex items-center px-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-blue-700 flex-shrink-0">
      ...
      {/* Navigation */}
      <nav className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent hover:scrollbar-thumb-gray-400 pt-6 px-3 pb-6">
